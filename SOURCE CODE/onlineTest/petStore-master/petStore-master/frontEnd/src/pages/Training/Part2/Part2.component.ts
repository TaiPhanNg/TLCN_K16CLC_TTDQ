import { Card4Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part2.component.less']
})
export class Part2Component implements OnInit {
  ...
  componentRef: ComponentRef<Card4Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card4Component);
