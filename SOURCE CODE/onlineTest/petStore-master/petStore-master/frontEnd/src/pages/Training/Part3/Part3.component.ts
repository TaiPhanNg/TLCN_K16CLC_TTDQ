import { Card5Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part3.component.less']
})
export class Part3Component implements OnInit {
  ...
  componentRef: ComponentRef<Card5Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card5Component);
