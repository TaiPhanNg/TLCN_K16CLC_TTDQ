import { Card9Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part7.component.less']
})
export class Part7Component implements OnInit {
  ...
  componentRef: ComponentRef<Card9Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card9Component);
