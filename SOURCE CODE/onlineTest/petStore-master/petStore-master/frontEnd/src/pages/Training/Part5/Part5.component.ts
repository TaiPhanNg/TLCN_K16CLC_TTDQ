import { Card7Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part5.component.less']
})
export class Part5Component implements OnInit {
  ...
  componentRef: ComponentRef<Card7Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card7Component);
