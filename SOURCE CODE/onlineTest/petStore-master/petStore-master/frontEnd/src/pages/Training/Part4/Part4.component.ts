import { Card6Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part4.component.less']
})
export class Part4Component implements OnInit {
  ...
  componentRef: ComponentRef<Card6Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card6Component);
