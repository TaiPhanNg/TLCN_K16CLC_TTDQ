import { Card8Component } from './cardQuestion/card.component';
...
@Component({
  ...
  styleUrls: ['./Part6.component.less']
})
export class Part6Component implements OnInit {
  ...
  componentRef: ComponentRef<Card8Component>;
  account
  ...
  renderCard(input) {
    ...
    const componentFactory = cfr.resolveComponentFactory(Card8Component);
