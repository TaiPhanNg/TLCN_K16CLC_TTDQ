...
export class ApiService {
  ...
  apiUrl = {
    subject: `${this.baseUrl}subjects`,
    semester: `${this.baseUrl}semesters`,
    test: `${this.baseUrl}tests`,
    option: `${this.baseUrl}options`,
    question: `${this.baseUrl}questions`,
    userTypes: `${this.baseUrl}user-types`,
    testDetail: `${this.baseUrl}test-details`,
    getByType: `${this.baseUrl}subjects/getSubjectsByClass2`,
    sgetByType: `${this.baseUrl}semesters/getPupilsByClass2`,
    users: {
